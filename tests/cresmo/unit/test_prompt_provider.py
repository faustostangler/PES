    ...
    def test_legacy_keys_resolution(self) -> None:
        ...
        provider._templates = {
            ...
            "stage2_pass_subsequent": {
                "task": "Legacy Pass Sub",
                "template": "{task} {channel_name} pass {pass_num}",
            },
            ...
            "synthesize_atomic_batch": {
                "task": "Legacy Batch 1",
                "template": "{task} {compendium_title}",
            },
            "stage5_batch_notes": {
                "task": "Legacy Batch 2",
                "template": "{task} {compendium_title}",
        ...
        assert (
            provider.get_gap_filler_prompt(2, 2, "Ch1", "f.txt", "raw")
            == "Legacy Pass Sub Ch1 pass 2"
        )
        ...
        # Stage 5 legacy
        assert (
            provider.get_batch_notes_prompt("Title", "Ch", "Body", "Targets")
            == "Legacy Batch 1 Title"
        )
        del provider._templates["synthesize_atomic_batch"]
        assert (
            provider.get_batch_notes_prompt("Title", "Ch", "Body", "Targets")
            == "Legacy Batch 2 Title"
        )
