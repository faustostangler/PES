...
- Formulate the Latin term with correct declension
- Provide the Portuguese translation in parentheses on first occurrence
- Ensure the term genuinely condenses a mechanism, not merely ornaments an existing one
- The coinage must be **original to the current text** — do not transplant terms from other essays
...
| Author | What the author's style shares |
| :--- | :--- |
| **Daniel Dennett** | Integrated naturalist architecture connecting biology, cognition, culture, morality, and institutions within a single causal chain |
| **Emil Cioran** | Existential density, constant proximity between beauty and abyss, willingness to directly confront the human condition |
| **Friedrich Nietzsche** | Long aphorisms, alternation between rational explanation and poetic language, concept creation, titles of strong symbolic and quasi-liturgical charge |
| **Jorge Luis Borges** | Oscillation between philosophical essay, metaphysical reflection, prose poetry, and scientific language; Latinisms and erudite references as part of aesthetic construction |
| **Nassim Nicholas Taleb** | Capacity to condense complex mechanisms into metaphors of great explanatory power, transforming images into conceptual tools |
...
1. **Fluid prose only**. No bullets, no lists, no tables, no LaTeX, no formulas, no diagrams, no highlight blocks.
