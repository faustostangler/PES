...
YAML metadata headers in playground/isb.ai/raw/[Channel_Name]/[Video_ID].txt.
"""
...
def run_cresmo_ingestion(
    playlist_path: Path = ISB_ROOT / "playlist.txt",
    csv_path: Path = ISB_ROOT / "brain.csv",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--playlist", default=str(ISB_ROOT / "playlist.txt"), help="Path to playlist seed text file")
    parser.add_argument("--csv", default=str(ISB_ROOT / "brain.csv"), help="Path to brain metadata CSV")
